  ...
  return (
    <section className="relative min-h-screen bg-[#0c0e1a] flex flex-col items-center justify-center text-center px-4">
      ...
      <button
        ...
        className="mt-10 px-10 py-4 rounded-2xl border border-purple-500 text-white text-lg font-medium flex items-center gap-3 hover:bg-purple-900/20 transition"
      >
        Continue to Site
